...
UNCATEGORIZED_CHANNELS_PATH = "uncategorized_channels.txt"  # Changed to root directory
...
def main():
    ...
    for category, channels in categorized_channels.items():
        if channels:
            ...
            file_path = UNCATEGORIZED_CHANNELS_PATH if category == UNCATEGORIZED_CATEGORY else os.path.join(TEMP_CHANNELS_DIR, file_name)
